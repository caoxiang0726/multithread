package com.cx.basic.synchronize;
 ...
 * 当一个线程访问“某对象”的“synchronized方法”或者“synchronized代码块”时，其他线程有3个规则
 *
 * 第一条: 其他线程对“该对象”的该“synchronized方法”或者“synchronized代码块”的访问将被阻塞。
  第二条: 其他线程仍然可以访问“该对象”的非同步代码块。
  第三条: 其他线程对“该对象”的其他的“synchronized方法”或者“synchronized代码块”的访问将被阻塞。
 */
public class SynchronizidConcept {
